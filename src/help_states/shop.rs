...
use immi::{widgets::Interaction, Alignment};
    ...
    pub fn new() -> Self {
        ...
        let chars_ui = chars
            ...
            .map(|(count, v)| {
                ...
                let asset = load_from("font.ttf".into(), 50.0, Color::BLACK, builder);
                let render = Render::new(
                    Box::new(move |r, draw| {
                        ...
                        //*/
                        r(draw
                            .rescale(0.4, 0.4, &alignment)
                            .uniform_margin(place, 0.0, 0.0, 0.0))
                    }),
                    asset,
                );
                (render, v)
